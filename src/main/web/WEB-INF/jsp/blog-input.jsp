...
<header id="header">
    <ul id="menu">
        ...
        <li class="pull-right">
            ...
            <span class="fl" onclick="window.location.href='/logout'"> 注销  </span>
        </li>
    </ul>
</header>
<section id="main">
    ...
    <aside id="sidebar">
        ...
        <ul class="main-menu">
            <li>
                <a class="waves-effect" href="${pageContext.request.contextPath}/getCommentList"><i
                        class="zmdi zmdi-accounts-list"></i> 评论区 </a>
            </li>
            <li>
                <a class="waves-effect" href="${pageContext.request.contextPath}/getBlogList"><i
                        class="zmdi zmdi-accounts"></i> 个人博客 </a>
            </li>
        </ul>
        <!-- /菜单区 -->
    </aside>
    ...
    <section id="content">
        <div class="content_main" style="overflow:scroll;">
            ...
            <form action="${pageContext.request.contextPath}/addBlog2">
                <div style="margin-bottom: 20px;margin-left: 10px;margin-right: 10px;">
                    <input name="title" placeholder="标题" type="text" id="title"/>
                </div>
                <div style="margin-bottom: 20px;margin-left: 10px;margin-right: 10px;">
                    <textarea id="word" class="form-control" placeholder="博客内容" name="content"
                              style="height: 400px;"></textarea>
                </div>
                <button class="button" style="margin-left: 10px;width:50px;height:30px;" type="submit"> 提交</button>
            </form>
