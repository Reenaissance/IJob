    ...
    <section id="content">
        <div class="content_main" style="overflow:scroll;">
            <div style="height: 40px;padding-top: 10px;">
                &nbsp;&nbsp;&nbsp;
                <button class="button" onclick="window.location.href='${pageContext.request.contextPath}/addBlog1'"> 我要写博客 </button>
                &nbsp;&nbsp;&nbsp;
                <button class="button" onclick="window.location.href='${pageContext.request.contextPath}/checkMyBlog'"> 我的博客 </button>
            </div>
            <div class="iframe cur" >
                <table class="table table-hover">
                    ...
                    <c:forEach items="${List}" var="blog">
                        <tr onclick="window.location.href='${pageContext.request.contextPath}/checkBlog/${blog.blogId}'">
                            <td> ${blog.blogId}</td>
                            <td> ${blog.username} </td>
                            <td> ${blog.blogTitle}</td>
                            <td> <fmt:formatDate value="${blog.blogDate}" type="date"/> </td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
...
<cript src="${pageContext.request.contextPath} /plugins/BootstrapMenu.min.js"></cript>
