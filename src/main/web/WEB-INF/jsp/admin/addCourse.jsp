    ...
    <div class="modal-body">
        <form action="${pageContext.request.contextPath}/addCourse" method="post">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" name="courseId" class="form-control" placeholder="请输入课程ID">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label">用户链接</label>
                <div class="col-sm-8">
                    <input type="text" name="courseLink" class="form-control" placeholder="请输入课程链接">
                    <span class="help-block"></span>
                </div>
            </div>
            <br><br><br>
